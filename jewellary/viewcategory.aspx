<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMobile.Master" AutoEventWireup="true" CodeBehind="viewcategory.aspx.cs" Inherits="jewellary.viewregistration" %>
...
<a href="viewcategory.aspx?category_id=<%#Eval("category_id")%>">

    <img src="../image/dlt.jfif" height="40" width="40" onclick="return del();" />
</a>
                               </ItemTemplate>
                                </asp:TemplateField>    
